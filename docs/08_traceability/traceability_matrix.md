...
|---|---|---|---|---|---|---|---|---|---|---|
| TR-001 | BO-001 | FR-013 | FR | Generate adapted resume for a vacancy | Generate Resume, Resume Review | ResumeGenerationRequest, GeneratedResumeDraft | ResumeGenerationService, AiClient | TC-001 | Planned | Draft |
| TR-002 | BO-XXX | FR-XXX | FR | [Use case] | [Screen] | [Entity] | [Component] | TC-XXX | Not Started | Draft |

## 4. Details

### TR-001 AI Resume Generation Trace

*   **Business Objective:** BO-001 Reduce resume adaptation effort
*   **Requirement ID:** FR-013
*   **Requirement Type:** FR
*   **Use Case / Workflow:** Generate adapted resume for a vacancy
*   **UI Screen:** Generate Resume, Resume Review
*   **Data Entity:** ResumeGenerationRequest, GeneratedResumeDraft
*   **Service / Component:** ResumeGenerationService, AiClient
*   **Test Case:** TC-001
*   **Status:** Draft
*   **Traceability Notes:** This trace connects the core business goal of reducing manual resume adaptation effort to the AI resume generation requirement and the main workflow where the user submits vacancy data and receives a generated draft.
*   **Gaps / Follow-up:** Define acceptance criteria and test scenario for successful mock AI generation before implementation.

### TR-002 [Trace Item Title Template]

*   **Business Objective:** BO-XXX
*   **Requirement ID:** FR-XXX
*   **Requirement Type:** [BR / FR / NFR / CON / UC / UI]
